...
export default function Cryptocurrencies() {
  ...
  return (
    <div className="wrapper">
      ...
      <div className="crypto-statistics" width={"100%"} height="auto">
        <div className="crypto-categories-block">
          <div className="crypto-categories" id="scroll-categories">
            <Link to="/" className="crypto-categ crypto-categ-active">
              <LazyLoadImage className="category-image" width={16} height={16} src={CryptocurrenciesIcon} alt="Cryptocurrencies List Icon" />
              Cryptocurrencies
            </Link>
            ...
            <Link to="/cryptocurrencies/binance-smart-chain" className="crypto-categ">
              <LazyLoadImage
                ...
                alt="Binance Smart Chain Category Icon"
              />
              Binance Smart Chain
            </Link>
              ...
              {data.length === 0 ? (
                ...
                data.map((currency) => (
                  <tr key={currency.id}>
                    ...
                    <td>
                      <Link to={"/coin/" + currency.id} aria-label={currency.id}>
      ...
      <div className="crypto-pagination">
        <Pagination count={10} color="primary" showFirstButton showLastButton onChange={(_e, num) => navigate(`./page/${num}`)} />
      </div>
